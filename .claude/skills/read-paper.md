...
3. **移动 PDF 文件到分类目录**：
   - 使用 Bash 工具将 PDF 文件从原位置移动到步骤 2 创建的目标文件夹
   - 命令示例：`mv "原PDF路径" "papers/2026/MARS-2602.02660v1/2602.02660v1.pdf"`
   - 更新后续所有 Read 工具调用使用新的 PDF 路径
...
6. **探测 PDF 页数**：从第 1 页的 Read 结果中获取论文总页数信息，用于后续阶段规划分批读取范围。Read 工具每次最多读取 20 页。
